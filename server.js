...
<head>
  ...
  <style>
   ...
   .file-msg { display: flex; align-items: center; gap: 8px; font-size: 14px; }
   .file-msg span { background: #e0e0e0; padding: 6px 10px; border-radius: 12px; }
...
ALWAYS end your response with a new line, then exactly: RELATED_QUESTIONS:
Then list exactly 3 short follow-up questions, each on a new line starting with 1. 2. 3.
Do not add any text after the 3rd question.`
      },
     ...req.body.messages
    ];
